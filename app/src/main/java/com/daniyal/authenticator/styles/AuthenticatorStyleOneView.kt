...
import com.daniyal.authenticator.ui.theme.black1Color
import com.daniyal.authenticator.ui.theme.grayColor

@Composable
fun AuthenticatorStyleOneView(
...
@Composable
private fun AuthenticatorStyleOneItem(
    index: Int,
    text: String,
    ...
    Column(
        ...
        modifier = Modifier
            ...
            .drawBehind {
                ...
                drawLine(
                    if (isFocused) black1Color else grayColor,
                    Offset(0f, y),
                    Offset(size.width, y),
                    strokeWidth
                )
